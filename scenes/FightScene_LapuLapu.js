...
export default class FightScene_LapuLapu extends Phaser.Scene {
    constructor() {
        super("FightScene_LapuLapu");
    }
    ...
    preload() {
        ...
        charSheets.forEach(sheet => {
            this.load.spritesheet("player_" + sheet, "/assets/characters/LapuLapu/" + sheet + ".png", { frameWidth: 180, frameHeight: 180 });
        });
    ...
    createAnimations(prefix, enemyType=null) {
        const playerFrames = {
            idle:10, run:8, jump:3, fall:3, attack1:7, attack2:7, special:8, hit:3, death:7
        };
        const enemyFramesMap = {
            magellan: { idle:10, run:6, jump:2, fall:2, attack1:4, attack2:4, special:5, hit:3, death:9 },
    ...
    setupHealthBars(width) {
        ...
        this.playerNameText = this.add.text(20,70,"LAPU-LAPU",{fontFamily:"Arial Black",fontSize:20,color:"#fff",stroke:"#000",strokeThickness:4}).setOrigin(0,0.5);
